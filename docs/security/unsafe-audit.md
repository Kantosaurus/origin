...
Per spec ┬º11 GA acceptance criterion 3, `unsafe` is permitted only in:

- `origin-cas` ΓÇö mmap + zero-copy slicing.
- `origin-tui` ΓÇö SIMD `wide::u8x32` damage diff.
- `origin-ipc` ΓÇö shared file mapping for blob handoff.
