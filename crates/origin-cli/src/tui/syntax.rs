    ...
    const fn ts() -> Self {
        Self {
            keywords: &[
                ...
                "namespace", "never", "new", "null", "number", "object", "of", "private",
                "protected", "public", "readonly", "return", "string", "super", "switch", "this",
    ...
    const fn py() -> Self {
        Self {
            keywords: &[
                ...
                "return", "True", "False", "try", "while", "with", "yield", "match", "case",
            ],
            line_comments: &["#"],
            block_comments: false,
            string_delims: &['"', '\''],
    ...
    const fn bash() -> Self {
        Self {
            keywords: &[
                ...
                "continue", "local", "export", "readonly", "declare", "unset", "echo", "cd",
                "exit", "source", "alias",
            ],
            line_comments: &["#"],
            block_comments: false,
